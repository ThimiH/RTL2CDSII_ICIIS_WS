...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/ch02_gtkwave_waveform.png}
    \caption{GTKWave waveform showing the state machine transitions and signal behavior during simulation. The waveform displays the sequential addition process with state transitions from IDLE through ADD\_A, ADD\_B, ADD\_C, ADD\_D to DONE states.}
    \label{fig:ch02_gtkwave}
\end{figure}
